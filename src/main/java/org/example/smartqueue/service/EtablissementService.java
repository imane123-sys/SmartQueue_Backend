...
public interface  EtablissementService {
    List<EtablissementResponseDTO>findEtablissementsProchesParServices(String serviceNom,double latitude,double longitude);
    ...
    Page<TicketResponseDTO>getTicketsEtablissement(Long idEtablissement, Pageable pageable);
